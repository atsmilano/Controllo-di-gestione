...
$oRecord->addEvent("on_done_action", "Thumbs_on_done_action");
...
$cm->oPage->tplAddJs("ff.cm-showfiles-thumbs", array(
    "path" => FF_THEME_DIR . "/" . cm_getMainTheme() . "/javascript/restricted"
    , "file" => "cm-showfiles-thumbs.js"
));
