...
/*ADDED-ATS                
		if (self::$errors_handled[$errstr]["variables"] !== NULL)
		{
			if (isset(self::$errors_handled[$errstr]["variables"]["GLOBALS"]))
				self::$errors_handled[$errstr]["variables"] = self::removeGlobals(self::$errors_handled[$errstr]["variables"]);
			...
			self::structPrint(self::$errors_handled[$errstr]["variables"], 0, true);
			self::out('</div></td></tr>');
		}
		...
		// DISPLAY CONSTANTS
		if (self::$errors_handled[$errstr]["constants"] !== NULL)
		{
