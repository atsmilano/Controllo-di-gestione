...
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_area_riferimento`;
CREATE TABLE `fabbisogno_area_riferimento`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
...
-- ----------------------------
-- Records of fabbisogno_area_riferimento
-- ----------------------------
INSERT INTO `fabbisogno_area_riferimento` VALUES (1, 'A', 'Obiettivi formativi tecnico-professionali');
INSERT INTO `fabbisogno_area_riferimento` VALUES (2, 'B', 'Obiettivi formativi di processo');
INSERT INTO `fabbisogno_area_riferimento` VALUES (3, 'C', 'Obiettivi formativi di sistema');

-- ----------------------------
-- Table structure for fabbisogno_classe_priorita
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_classe_priorita`;
CREATE TABLE `fabbisogno_classe_priorita`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Records of fabbisogno_classe_priorita
-- ----------------------------
INSERT INTO `fabbisogno_classe_priorita` VALUES (1, 'Alta');
INSERT INTO `fabbisogno_classe_priorita` VALUES (2, 'Media');
INSERT INTO `fabbisogno_classe_priorita` VALUES (3, 'Bassa');

-- ----------------------------
-- Table structure for fabbisogno_destinatari
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_destinatari`;
CREATE TABLE `fabbisogno_destinatari`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_tabella_riferimento_destinatari_validi` int(11) NOT NULL,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fabbisogno_destinatari
-- ----------------------------
INSERT INTO `fabbisogno_destinatari` VALUES (1, 155, 'Tutte le professioni sanitarie');
INSERT INTO `fabbisogno_destinatari` VALUES (2, 156, 'Altre figure');
INSERT INTO `fabbisogno_destinatari` VALUES (3, 154, 'Tutte le professioni sanitarie e Altre figure');

-- ----------------------------
-- Table structure for fabbisogno_docenti
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_docenti`;
CREATE TABLE `fabbisogno_docenti`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
...
-- ----------------------------
-- Records of fabbisogno_docenti
-- ----------------------------
INSERT INTO `fabbisogno_docenti` VALUES (1, 'Interni senza oneri');
INSERT INTO `fabbisogno_docenti` VALUES (2, 'Interni con oneri');
INSERT INTO `fabbisogno_docenti` VALUES (3, 'Esterni senza oneri');
INSERT INTO `fabbisogno_docenti` VALUES (4, 'Esterni con oneri');

-- ----------------------------
-- Table structure for fabbisogno_docenti_richiesta
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_docenti_richiesta`;
CREATE TABLE `fabbisogno_docenti_richiesta`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_richiesta` int(11) NOT NULL,
  `ID_docenti` int(11) NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Fixed;

-- ----------------------------
-- Table structure for fabbisogno_modalita_valutazione_apprendimento
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_modalita_valutazione_apprendimento`;
CREATE TABLE `fabbisogno_modalita_valutazione_apprendimento`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
...
-- ----------------------------
-- Records of fabbisogno_modalita_valutazione_apprendimento
-- ----------------------------
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (2, 'Test a scelta multipla (3 domande per ogni credito, a risposta quadrupla)');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (3, 'Questionario a risposta aperta');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (4, 'Colloquio');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (5, 'Elaborazione di relazioni intermedie');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (6, 'Redazione documento conclusivo');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (7, 'Valutazione da parte del Responsabile Scientifico del progetto formativo');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (8, 'Valutazione da parte di docente - tutor esperto');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (9, 'Valutazione con pratica');
INSERT INTO `fabbisogno_modalita_valutazione_apprendimento` VALUES (10, 'Valutazione non prevista (Convegni – Congressi – Simposi – Conferenze - oltre 200 partecipanti)');

-- ----------------------------
-- Table structure for fabbisogno_obiettivo_riferimento
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_obiettivo_riferimento`;
CREATE TABLE `fabbisogno_obiettivo_riferimento`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_tabella_riferimento_tipi_obiettivi` int(11) NOT NULL,
  `ID_area_riferimento` int(11) NOT NULL,
  `codice` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- ----------------------------
-- Records of fabbisogno_obiettivo_riferimento
-- ----------------------------
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (4, 20, 1, '10', 'Epidemiologia - prevenzione e promozione della salute diagnostica – tossicologia con acquisizione di nozioni tecnico-professionali;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (5, 28, 1, '18', 'Contenuti tecnico-professionali (conoscenze e competenze) specifici di ciascuna professione, di ciascuna specializzazione e di ciascuna attività ultraspecialistica, ivi incluse le malattie rare e la medicina di genere;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (6, 29, 1, '19', 'Medicine non convenzionali: valutazione dell\'efficacia in ragione degli esiti e degli ambiti di complementarietà;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (7, 30, 1, '20', 'Tematiche speciali del S.S.N. e/o S.S.R. a carattere urgente e/o straordinario individuate dalla Commissionale nazionale per la formazione continua e dalle regioni/province autonome per far fronte a specifiche emergenze sanitarie con acquisizione di nozio');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (8, 31, 1, '21', 'Trattamento del dolore acuto e cronico. Palliazione;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (9, 32, 1, '22', 'Fragilità e cronicità (minori, anziani, dipendenze da stupefacenti, alcool e ludopatia, salute mentale), nuove povertà, tutela degli aspetti assistenziali, sociosanitari e socio-assistenziali;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (10, 33, 1, '23', 'Sicurezza e igiene alimentari, nutrizione e/o patologie correlate;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (11, 34, 1, '24', 'Sanità veterinaria. Attività presso gli stabulari. Sanità vegetale;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (12, 35, 1, '25', 'Farmaco epidemiologia, farmacoeconomia, farmacovigilanza;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (13, 36, 1, '26', 'Sicurezza e igiene ambientali (aria, acqua e suolo) e/o patologie correlate;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (14, 37, 1, '27', 'Sicurezza e igiene negli ambienti e nei luoghi di lavoro e patologie correlate. Radioprotezione;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (15, 38, 1, '28', 'Implementazione della cultura e della sicurezza in materia di donazione trapianto;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (16, 39, 1, '29', 'Innovazione tecnologica: valutazione, miglioramento dei processi di gestione delle tecnologie biomediche, chimiche, fisiche e dei dispositivi medici. Health Technology Assessment;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (17, 24, 1, '34', 'Accreditamento strutture sanitarie e dei professionisti. La cultura della qualità, procedure e certificazioni, con acquisizione di nozioni tecnico-professionali;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (18, 27, 1, '35', 'Argomenti di carattere generale: sanità digitale, informatica di livello avanzato e lingua inglese scientifica; normativa in materia sanitaria: principi etici e civili del S.S.N. e normativa su materie oggetto delle singole professioni sanitarie, con acqu');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (19, 46, 1, '36', 'Valutazione, analisi, studio, caratterizzazione identificazione di: agenti, sostanze, preparati, materiarli ed articoli e loro interazione con la salute e la sicurezza;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (20, 47, 1, '37', 'Metodologie, tecniche e procedimenti di misura e indagine analitiche, diagnostiche e di screening, anche in ambito ambientale, del territorio e del patrimonio artistico e culturale. Raccolta, processamento ed elaborazione dei dati e dell’informazione;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (21, 48, 1, '38', 'Verifiche ed accertamenti nei porti e sulle navi anche ai fini della sicurezza; valutazioni ed analisi di esplosivi, combustibili, acceleranti e loro tracce; gestione delle emergenze e degli incidenti rilevanti');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (22, 13, 2, '3', 'Documentazione clinica. Percorsi clinico-assistenziali diagnostici e riabilitativi, profili di assistenza - profili di cura;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (23, 14, 2, '4', 'Appropriatezza delle prestazioni sanitarie, sistemi di valutazione, verifica e miglioramento dell\'efficienza ed efficacia. Livelli essenziali di assistenza (LEA);');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (24, 17, 2, '7', 'La comunicazione efficace interna, esterna, con paziente. La privacy ed il consenso informato;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (25, 18, 2, '8', 'Integrazione interprofessionale e multiprofessionale, interistituzionale;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (26, 19, 2, '9', 'Integrazione tra assistenza territoriale ed ospedaliera;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (27, 21, 2, '11', 'Management sistema salute. Innovazione gestionale e sperimentazione di modelli organizzativi e gestionali;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (28, 22, 2, '12', 'Aspetti relazionali e umanizzazione delle cure;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (29, 23, 2, '13', 'Metodologia e tecniche di comunicazione, anche in relazione allo sviluppo dei programmi nazionali e regionali di prevenzione primaria;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (30, 44, 2, '14', 'Accreditamento strutture sanitarie e dei professionisti. La cultura della qualità, procedure e certificazione, con acquisizione di nozioni di processo;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (31, 25, 2, '15', 'Multiculturalità e cultura dell\'accoglienza nell\' attività sanitaria, medicina relativa alle popolazioni migranti;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (32, 40, 2, '30', 'Epidemiologia - prevenzione e promozione della salute diagnostica – tossicologia con acquisizione di nozioni di processo;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (33, 43, 2, '32', 'Tematiche speciali del S.S.N. e/o S.S.R. a carattere urgente e/o straordinario individuate dalla commissionale nazionale per la formazione continua e dalle regioni/province autonome per far fronte a specifiche emergenze sanitarie con acquisizione di nozio');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (34, 11, 3, '1', 'Applicazione nella pratica quotidiana dei principi e delle procedure dell\'evidence based practice (EBM - EBN - EBP);');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (35, 12, 3, '2', 'Linee guida - protocolli – procedure;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (36, 15, 3, '5', 'Principi, procedure e strumenti per il governo clinico delle attività sanitarie;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (37, 16, 3, '6', 'Sicurezza del paziente, risk management e responsabilità professionale;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (38, 26, 3, '16', 'Etica, bioetica e deontologia;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (39, 45, 3, '17', 'Argomenti di carattere generale: sanità digitale, informatica di livello avanzato e lingua inglese scientifica. Normativa in materia sanitaria: i principi etici e civili del S.S.N. e normativa su materie oggetto delle singole professioni sanitarie, con ac');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (40, 41, 3, '31', 'Epidemiologia - prevenzione e promozione della salute diagnostica – tossicologia con acquisizione di nozioni di sistema;');
INSERT INTO `fabbisogno_obiettivo_riferimento` VALUES (41, 42, 3, '33', 'Tematiche speciali del S.S.N. e/o S.S.R. a carattere urgente e/o straordinario individuate dalla commissionale nazionale per la formazione continua e dalle regioni/province autonome per far fronte a specifiche emergenze sanitarie con acquisizione di nozio');

-- ----------------------------
-- Table structure for fabbisogno_operatore_formazione
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_operatore_formazione`;
CREATE TABLE `fabbisogno_operatore_formazione`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `matricola_personale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_introduzione` date NULL DEFAULT NULL,
  `data_termine` date NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for fabbisogno_referente_cdr
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_referente_cdr`;
CREATE TABLE `fabbisogno_referente_cdr`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `matricola_personale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `data_introduzione` date NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for fabbisogno_richiesta
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_richiesta`;
CREATE TABLE `fabbisogno_richiesta`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_anno_budget` int(11) NOT NULL,
  `matricola_creazione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `matricola_responsabile_scientifico` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `matricola_referente_segreteria` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `mail_segreteria_organizzativa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `telefono_segreteria_organizzativa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `titolo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `ID_destinatari` int(11) NULL DEFAULT NULL,
  `apertura_destinatari_esterni` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `quota_iscrizione_destinatari_esterni` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `ID_classe_priorita` int(11) NULL DEFAULT NULL,
  `formazione_obbligatoria` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `descrizione` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `ID_area_riferimento` int(11) NULL DEFAULT NULL,
  `ID_obiettivo_riferimento` int(11) NULL DEFAULT NULL,
  `obiettivi_formativi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `ID_modalita_valutazione_apprendimento` int(11) NULL DEFAULT NULL,
  `valutazione_ricaduta` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `ID_trimestre_avvio` int(11) NULL DEFAULT NULL,
  `ID_docenti` int(11) NULL DEFAULT NULL,
  `n_posti` int(11) NULL DEFAULT NULL,
  `n_ore` int(11) NULL DEFAULT NULL,
  `n_edizioni` int(11) NULL DEFAULT NULL,
  `costi_edizione` int(11) NULL DEFAULT NULL,
  `accreditamento_ecm` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
...
-- ----------------------------
-- Table structure for fabbisogno_tipologia
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_tipologia`;
CREATE TABLE `fabbisogno_tipologia`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_tabella_riferimento_attivita` int(11) NOT NULL,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fabbisogno_tipologia
-- ----------------------------
INSERT INTO `fabbisogno_tipologia` VALUES (1, 11, 'RES - Formazione residenziale classica (max 100 partecipanti)');
INSERT INTO `fabbisogno_tipologia` VALUES (2, 10, 'RES - Formazione residenziale classica (da 101 a 200 partecipanti)');
INSERT INTO `fabbisogno_tipologia` VALUES (3, 9, 'RES - Convegni, congressi, simposi e conferenze (oltre 200 partecipanti)');
INSERT INTO `fabbisogno_tipologia` VALUES (4, 12, 'RES - Videoconferenza');
INSERT INTO `fabbisogno_tipologia` VALUES (5, 5, 'FSC - Training individualizzato');
INSERT INTO `fabbisogno_tipologia` VALUES (6, 8, 'FSC - Gruppi di miglioramento');
INSERT INTO `fabbisogno_tipologia` VALUES (7, 6, 'FSC - Attività di ricerca');
INSERT INTO `fabbisogno_tipologia` VALUES (8, 1, 'FAD - E-learning');
INSERT INTO `fabbisogno_tipologia` VALUES (9, 4, 'FAD - sincrona');
INSERT INTO `fabbisogno_tipologia` VALUES (10, 1, 'Formazione Blended');
INSERT INTO `fabbisogno_tipologia` VALUES (11, 3, 'FAD - Strumenti informatici / cartacei');

-- ----------------------------
-- Table structure for fabbisogno_trimestre_avvio
-- ----------------------------
DROP TABLE IF EXISTS `fabbisogno_trimestre_avvio`;
CREATE TABLE `fabbisogno_trimestre_avvio`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Records of fabbisogno_trimestre_avvio
-- ----------------------------
INSERT INTO `fabbisogno_trimestre_avvio` VALUES (1, 'I Trimestre');
INSERT INTO `fabbisogno_trimestre_avvio` VALUES (2, 'II Trimestre');
INSERT INTO `fabbisogno_trimestre_avvio` VALUES (3, 'III Trimestre');
INSERT INTO `fabbisogno_trimestre_avvio` VALUES (4, 'IV Trimestre');
...
-- ----------------------------
-- Table structure for obind_assegnazione_individuale
-- ----------------------------
DROP TABLE IF EXISTS `obind_assegnazione_individuale`;
CREATE TABLE `obind_assegnazione_individuale`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ID_anno_budget` int(11) NOT NULL,
  `matricola_personale` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `matricola_inserimento` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `matricola_responsabile_assegnazione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `descrizione` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ID_obiettivo` int(11) NULL DEFAULT NULL,
  `datetime_inserimento` datetime(0) NOT NULL,
  `datetime_chiusura` datetime(0) NULL DEFAULT NULL,
  `datetime_accettazione` datetime(0) NULL DEFAULT NULL,
  `rendicontazione` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `datetime_chiusura_rendicontazione` datetime(0) NULL DEFAULT NULL,
  `note_responsabile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `datetime_chiusura_modifiche` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_accettazione`;
CREATE TABLE `ru_accettazione`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ID_anno_budget` int(11) NOT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_cdr_abilitato`;
CREATE TABLE `ru_cdr_abilitato`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `programmazione_strategica` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for ru_dg
-- ----------------------------
DROP TABLE IF EXISTS `ru_dg`;
CREATE TABLE `ru_dg`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_direzione_riferimento`;
CREATE TABLE `ru_direzione_riferimento`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_parere`;
CREATE TABLE `ru_parere`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `esito` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_priorita`;
CREATE TABLE `ru_priorita`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_richiesta`;
CREATE TABLE `ru_richiesta`  (
...
-- ----------------------------
-- Table structure for ru_tempi
-- ----------------------------
DROP TABLE IF EXISTS `ru_tempi`;
CREATE TABLE `ru_tempi`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_tipo_richiesta`;
CREATE TABLE `ru_tipo_richiesta`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `descrizione` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
DROP TABLE IF EXISTS `ru_uo_competente`;
CREATE TABLE `ru_uo_competente`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `codice_cdr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `anno_inizio` int(11) NULL DEFAULT NULL,
  `anno_termine` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `scadenze_scadenza`  (
  ...
  `oggetto` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE `valutazioni_periodo`  (
  ...
  `visualizzazione_obiettivi` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `visualizzazione_pesi_obiettivi_responsabile` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `valutatore_anonimo` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `data_inizio` date NOT NULL,
  `data_fine` date NOT NULL,
...
CREATE TABLE `valutazioni_valutazione_periodica`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `matricola_proponente` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `matricola_valutatore` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `matricola_valutato` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `data_firma_proponente` date NULL DEFAULT NULL,
