...
function cm_getFrameworkCss_settings($name = null) {
...
function cm_getFontIcon_settings($name = null) {
...
function cm_getFontIcon($font_icon_name = null)
{
    ...
    if(strlen($font_icon_name)) {
        if($font_icon_name == "no") {
            ...
            $font_icon = cm_getFontIcon_settings($font_icon_name);
...
function cm_getFrameworkCss($framework_name = null) 
{
	static $framework_css = null;
            ...
            if(strpos($framework_name, "-fluid") !== false) {
                ...
                $framework_css = array(
                    ...
                    , "theme" => array(
                        ...
                        , "css" => $framework_css_settings["theme"][$arrFrameworkCss[1]]
                    )
                );
	            ...
	            $framework_css_settings = cm_getFrameworkCss_settings($framework_name);
                $framework_css = array(
                    "name" => $framework_name
                    , "is_fluid" => false
                    , "class" => $framework_css_settings["class"]
...
*/         
        ...
        case "wrap": 
        case "wrap-fluid":
        	$framework_css_settings = cm_getFrameworkCss_settings($framework_css["name"]);
