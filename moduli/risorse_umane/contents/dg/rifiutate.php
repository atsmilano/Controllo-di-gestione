...
$grid_uo_competente_rifiutate = array();
foreach (RURichiesta::getAll(array("ID_anno_budget"=>$anno->id)) as $richiesta) {
    ...
    if ($id_stato_avanzamento >= 12) {       
        ...
        $grid_uo_competente_rifiutate[] = $record;            
    }
}

$oGrid = RURichiesta::getGridRichieste("richieste-rifiutate", "Richieste di competenza rifiutate", $grid_uo_competente_rifiutate, true);
